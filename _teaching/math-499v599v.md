...
### Note
For those who are interested in auditing this course, the schedule is MWF 3:05 - 3:50 at Peabody Hall Classroom 0309 or via the Zoom [link](https://uark.zoom.us/j/83459027040?pwd=QmsrUHY1R3RrZU9OMEg2L2NaL1dWZz09). The material is available in the UArk GitLab [repository](https://git.uark.edu/jiahuic/math-499v-599v-mfml). Both the Zoom link and GitLab repo require a UARK account. You can also email me for more information.
...
We will commence with an introduction to Python, highlighting prominent packages and standard datasets pivotal to the field. As we delve deeper, students will be introduced to a range of ML algorithms such as linear regression, logistic regression, k-means, k-nearest neighbors (KNN), support vector machines (SVM), naive Bayes, Hopfield networks, decision trees, random forests, gradient-boosted trees, deep neural networks (artificial neural networks, ANN), graph neural networks, and manifold learning techniques.
